...
class _HomepageState extends State<Homepage> with TickerProviderStateMixin {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Fresh matches loaded!'),
        ...
        children: [
          Scaffold(
            ...
            body: _selectedIndex == 0
                ...
                : _buildOtherPagesWithAppBar(),
            bottomNavigationBar: _selectedIndex == 0 ? _buildBottomNavigation(screenWidth) : null,
          ),
  ...
  Widget _buildDiscoverPage(double screenWidth, double screenHeight) {
    return Scaffold(
      ...
      body: _buildExploreContent(screenWidth, screenHeight),
    );
  }

  Widget _buildExploreContent(double screenWidth, double screenHeight) {
    if (_isLoading) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget _buildOtherPagesWithAppBar() {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 2,
        ...
        child: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              ...
              activeIcon: Icon(Icons.explore, size: MediaQuery.of(context).size.width * 0.06),
              label: "Explore",
            ),
            BottomNavigationBarItem(
              icon: Icon(
              ...
              activeIcon: Icon(Icons.favorite, size: MediaQuery.of(context).size.width * 0.06),
              label: 'Matches',
            ),
            BottomNavigationBarItem(
              icon: Icon(Icons.person_outline, size: MediaQuery.of(context).size.width * 0.06),
              activeIcon: Icon(Icons.person, size: MediaQuery.of(context).size.width * 0.06),
              label: "Profile",
            ),
          ],
        ),

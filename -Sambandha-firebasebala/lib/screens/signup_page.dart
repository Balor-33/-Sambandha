...
// Step 3: Email Verification Page (using your UI design)
    ...
    try {
      ...
      if (user != null && user.emailVerified) {
        ...
        Navigator.pushReplacementNamed(
          context,
          '/first-name', // Navigate to your existing profile setup
          // arguments: ProfileSetupData(), // if you need to pass data
        );
      } else {
